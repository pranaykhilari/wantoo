...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _ideaList = __webpack_require__(159);

	var _notificationList = __webpack_require__(170);

	var _merge = __webpack_require__(171);
	...
	try {
		...
		_reactDom2.default.render(_react2.default.createElement(_ideaList.IdeaList, { isHomePage: isHomePage, isIdeaList: isIdeaList }), document.getElementById('ideaList'));
	} catch (error) {
		console.log(error);
	}

	try {
		_reactDom2.default.render(_react2.default.createElement(_notificationList.NotificationList, null), document.getElementById('notificationList'));
	} catch (error) {
		console.log(error);
	}

	try {
		_reactDom2.default.render(_react2.default.createElement(_merge.Merge, null), document.getElementById('merge'));
	} catch (error) {
		console.log(error);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _ideaItem = __webpack_require__(162);

	var _helper = __webpack_require__(164);
	...
	var IdeaList = exports.IdeaList = function (_React$Component) {
		_inherits(IdeaList, _React$Component);

		function IdeaList(props) {
			_classCallCheck(this, IdeaList);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(IdeaList).call(this, props));
		...
		_createClass(IdeaList, [{
			key: 'liveSearchResultsUpdate',
			value: function liveSearchResultsUpdate(results, searchSource, searchTerm) {
				...
				if (results && results.hits.length > 0) {
					...
					for (var i = 0; i < results.hits.length; i++) {
						...
						this.newArray.push(_react2.default.createElement(_ideaItem.IdeaItem, { key: i, idea: idea[i], isSearchResult: true }));
					}
			...
			key: '_hideUIElements',
			value: function _hideUIElements() {
			...
			key: '_showUIElements',
			value: function _showUIElements() {
				if (this.searchSource === 'searchInput') {
			...
			key: '_loadIdeas',
			value: function _loadIdeas() {
				//copy array
				this.newArray = [];

				//load all the initial ideas from Django into our current ideas to display
				for (var i = 0; i < this.state.initialIdeas.length; i++) {
					this.newArray.push(_react2.default.createElement(_ideaItem.IdeaItem, { key: i, idea: this.state.initialIdeas[i], isSearchResult: false }));
				}
			...
			value: function render() {
				...
				var liveSearchLayout,
				    ideaLiveSearchLayout,
					...
					if (!this.props.isHomePage) {
						if (this.state.currentIdeas.length <= 0) {
							...
							if (this.props.isIdeaList) {
								...
								isHidden = false;
								showNoResultsMsg = true;
								if (window.userInfo.company) $('#_modal-Summary').modal('show');
							}
							...
							if ((0, _helper.getUrlParameter)('status')) {
				...
				var ideaListClasses = (0, _classnames2.default)({
					'comp-ideaList': true,
					'isHidden': isHidden,
				...
				return _react2.default.createElement(
					'div',
					{ className: ideaListClasses },
					_react2.default.createElement(
						'h2',
						{ className: 'comp-ideaList__searchInfo' },
						this.state.currentIdeas.length,
						' ideas match ',
						_react2.default.createElement(
							'span',
							{ className: 'comp-ideaList__searchTerm' },
							'"',
							this.searchTerm,
							'"'
						)
					...
					_react2.default.createElement(
						'p',
						{ className: 'comp-ideaList__blurb' },
						'Check out these similar ideas'
					),
					_react2.default.createElement(
						'p',
						{ className: 'comp-ideaList__noResults' },
						resultsMsg,
						' ',
						this.props.isIdeaList ? _react2.default.createElement(
							'a',
							{ className: 'noResults__link', href: '/' + window.userInfo.company },
							'Add your idea.'
						) : false
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	(function () {
		...
		} else if ("function" === 'function' && _typeof(__webpack_require__(161)) === 'object' && __webpack_require__(161)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _tracking = __webpack_require__(163);
	...
	var IdeaItem = exports.IdeaItem = function (_React$Component) {
		_inherits(IdeaItem, _React$Component);

		function IdeaItem(props) {
			_classCallCheck(this, IdeaItem);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(IdeaItem).call(this, props));

			_this.state = {
				voted: _this.props.idea.voted == 'not_voted' ? false : true,
				vote_count: _this.props.idea.vote_count
			};
			return _this;
		}
	 ...
	 */
		...
		_createClass(IdeaItem, [{
			key: '_vote',
			value: function _vote() {
				if ((0, _helper.isUserAuthed)()) {
					...
					if (this.state.voted) {
						...
						(0, _tracking.track)('unvote clicked', {
							'source': 'idea list'
						});
					} else {
						newVoteCount = newVoteCount + 1;
						this.setState({ vote_count: newVoteCount });
						(0, _tracking.track)('vote clicked', {
							'source': 'idea list'
						});
					}

					//send our vote
					(0, _API.api_vote)(this.props.idea.idea_id, this.state.voted);
				} else {
					(0, _helper.showModal)('_modal-login');
				}
			}
	  ...
	  */
			...
			value: function render() {
				...
				var voteButtonClasses = (0, _classnames2.default)({
					'-cont-vote': true,
				...
				if (this.props.idea.voted_users) {
					...
					for (var i = 0; i < len; i++) {
						...
						if (urls.voted_by !== urls.created_by) supporters.push(_react2.default.createElement(
							'a',
							{ href: urls.voted_by, key: this.props.idea.voted_users.id[i], onClick: _tracking.track.bind(this, 'member clicked', { 'source': 'idea list' }), className: '-profile-link' },
							_react2.default.createElement('img', { className: '-profile-pic -profile-left', src: this.props.idea.voted_users.gravatar_url[i] })
						));
					}
				}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'h3',
								{ className: '-score _vote-count' },
								this.state.vote_count
							),
							_react2.default.createElement(
								'button',
								{ onClick: this._vote.bind(this), className: '-btn-vote', 'data-id': this.props.idea.idea_id },
								'want'
							)
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ href: urls.idea, onClick: _tracking.track.bind(this, 'idea title clicked', { 'source': 'idea list' }), className: '-title' },
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											'a',
											{ href: urls.created_by, onClick: _tracking.track.bind(this, 'member clicked', { 'source': 'idea list' }), className: '-profile-link' },
											_react2.default.createElement('img', { className: '-profile-pic', src: this.props.idea.created_by.gravatar_url, alt: '' })
										),
										supporters
									)
								),
								_react2.default.createElement(
									'a',
									{ href: urls.idea, onClick: _tracking.track.bind(this, 'comments clicked', { 'source': 'idea list' }) },
									_react2.default.createElement(
										'span',
										{ className: '-comments' },
										'+ ',
										this.props.idea.comment_count,
										' comments'
									)
								),
								_react2.default.createElement(
									'a',
									{ href: urls.status, style: statusStyle, className: '-status-badge' },
									this.props.idea.status.title
								)
							)
						)
					),
...
/***/ function(module, exports) {
	...
	exports.isUserAuthed = isUserAuthed;
	exports.showModal = showModal;
	exports.createMarkup = createMarkup;
	exports.getUrlParameter = getUrlParameter;
	exports.checkUrlParameterExists = checkUrlParameterExists;
...
/***/ function(module, exports) {
	...
	exports.publishIdea = publishIdea;
	exports.api_vote = api_vote;
	exports.algolia_search = algolia_search;
	...
	function api_vote(id, alreadyVoted) {
		console.log("vote!");
		console.log(id);
	...
	function algolia_search() {
		var searchString = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/stylus-loader/index.js!./_ideaList.styl", function() {
				var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/stylus-loader/index.js!./_ideaList.styl");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".test {\n  color: #f00;\n}\n.comp-ideaList {\n  width: 100%;\n}\n.comp-ideaList.is-empty.comp-ideaList--liveSearch .comp-ideaList__noResults {\n  display: block;\n}\n.comp-ideaList.is-empty .comp-ideaList__noResults {\n  display: block;\n}\n.comp-ideaList.comp-ideaList--liveSearch .comp-ideaList__searchInfo {\n  display: block;\n}\n.comp-ideaList.comp-ideaList--ideaInputLiveSearch .comp-ideaList__blurb {\n  display: block;\n}\n.comp-ideaList.comp-ideaList--ideaInputLiveSearch .comp-ideaList__searchInfo {\n  display: none;\n}\n.comp-ideaList .comp-ideaList__searchTerm {\n  font-weight: 600;\n}\n.comp-ideaList .comp-ideaList__blurb {\n  color: #b0afaf;\n  font-size: 16px;\n  font-weight: 600;\n  display: none;\n}\n.comp-ideaList .comp-ideaList__searchInfo {\n  display: none;\n  font-size: 20px;\n  font-weight: normal;\n  text-transform: uppercase;\n  margin: 0 0 36px;\n}\n.comp-ideaList .comp-ideaList__noResults {\n  color: #000;\n  display: none;\n  font-size: 22px;\n}\n.comp-ideaList .noResults__list {\n  list-style: none;\n  padding: 0px;\n}\n.comp-ideaList .noResults__list .noResults__item {\n  padding-top: 20px;\n}\n.comp-ideaList.isHidden {\n  display: none;\n}\n.comp-ideaList .-no-ideas-message {\n  text-align: center;\n  margin: 0 auto;\n  font-size: 18px;\n  color: #a7a7a7;\n  font-style: italic;\n  margin-top: 30px;\n}\n.comp-ideaList .-idea {\n  background: #fff;\n  position: relative;\n  width: 100%;\n  text-decoration: none;\n  float: left;\n  display: flex;\n  align-items: center;\n  padding: 11px 0;\n  margin: 0;\n  min-height: auto;\n}\n.comp-ideaList .-idea:first-child {\n  padding-top: 0;\n  margin-top: -10px;\n}\n.comp-ideaList .-idea .-status-badge {\n  color: #fff;\n  border-radius: 10px;\n  padding: 0 12px;\n  font-size: 8px;\n  text-transform: uppercase;\n  line-height: 19px;\n  display: inline-block;\n}\n.comp-ideaList .-idea:last-child {\n  border: none;\n}\n.comp-ideaList .-idea .-col-vote {\n  height: 60px;\n  margin-top: 6px;\n}\n.comp-ideaList .-idea .-col-vote,\n.comp-ideaList .-idea .-col-vote-small {\n  margin-right: 5.5%;\n  float: left;\n}\n.comp-ideaList .-idea .-col-vote .-cont-vote,\n.comp-ideaList .-idea .-col-vote-small .-cont-vote {\n  height: 100px;\n  margin-top: 0;\n}\n.comp-ideaList .-idea .-col-vote .-cont-vote.voted .-btn-vote,\n.comp-ideaList .-idea .-col-vote-small .-cont-vote.voted .-btn-vote {\n  border: 2px solid #e94095;\n  background: transparent;\n  color: #e94095;\n}\n.comp-ideaList .-idea .-col-vote .-cont-vote.not_voted .-btn-vote,\n.comp-ideaList .-idea .-col-vote-small .-cont-vote.not_voted .-btn-vote {\n  border: 2px solid #959595;\n  background: transparent;\n  color: #959595;\n}\n.comp-ideaList .-idea .-col-vote .-cont-vote.not_voted .-btn-vote:hover,\n.comp-ideaList .-idea .-col-vote-small .-cont-vote.not_voted .-btn-vote:hover {\n  background: #e94095;\n  border-color: #e94095;\n  color: #fff;\n}\n.comp-ideaList .-idea .-col-vote .-cont-vote .-score,\n.comp-ideaList .-idea .-col-vote-small .-cont-vote .-score {\n  color: #000;\n  margin: 0;\n  font-size: 22px;\n  font-weight: bold;\n  text-align: center;\n  width: 100%;\n  margin-bottom: 3px;\n}\n.comp-ideaList .-idea .-col-vote .-cont-vote .-btn-vote,\n.comp-ideaList .-idea .-col-vote-small .-cont-vote .-btn-vote {\n  width: 55px;\n  outline: none;\n  font-size: 16px;\n  font-weight: normal;\n  margin: 0 auto;\n  display: block;\n  height: 25px;\n  padding: 0;\n  line-height: 19px;\n}\n.comp-ideaList .-idea .-col-vote-small {\n  display: none;\n}\n.comp-ideaList .-idea .-col-vote-small .-cont-vote .-score {\n  text-align: left;\n  margin-left: 35px;\n  font-size: 14px;\n  font-weight: normal;\n  color: #a3a3a3;\n  margin-top: 12px;\n  margin-bottom: 15px;\n}\n.comp-ideaList .-idea .-col-vote-small .-cont-vote .btn-vote {\n  width: 100%;\n  height: 60px;\n}\n.comp-ideaList .-idea .-col-info {\n  float: left;\n  padding: 6px;\n}\n.comp-ideaList .-idea .-col-info .-cont-info {\n  min-height: 50px;\n}\n.comp-ideaList .-idea .-col-info .-cont-info a:focus {\n  text-decoration: none;\n}\n.comp-ideaList .-idea .-col-info .-cont-info a:hover {\n  text-decoration: none;\n}\n.comp-ideaList .-idea .-col-info .-cont-info a:hover .-comments {\n  color: #e94095;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-title {\n  color: #000;\n  font-size: 20px;\n  margin: 0 0 5px 0;\n  font-weight: bold;\n  cursor: pointer;\n  text-decoration: none;\n  display: block;\n  max-width: 100%;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-title::first-letter {\n  text-transform: uppercase;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-title:hover {\n  color: #e94095;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-activity {\n  color: #a3a3a3;\n  font-size: 13px;\n  margin: 0;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-activity .-category {\n  background-size: 16px;\n  background-image: url(\"/static/dashboard/img/icons/category.svg\");\n  background-position: 0 center;\n  background-repeat: no-repeat;\n  padding-left: 25px;\n  color: #a3a3a3;\n  text-decoration: none;\n  margin-right: 15px;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-activity .-category:hover {\n  color: #e94095;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-activity .-comments {\n  color: #a3a3a3;\n  background-size: 16px;\n  margin-right: 20px;\n  margin-left: -10px;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-activity .-recent {\n  background-size: 16px;\n  margin-right: 15px;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-activity .-recent .-profile-link {\n  color: #a3a3a3;\n  text-decoration: none;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-activity .-recent .-profile-link:hover {\n  color: #e94095;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-activity .-recent .-profile-pic {\n  border: 1px solid #a7a7a7;\n  border-radius: 50%;\n  width: 22px;\n  margin-right: 7px;\n  border: 1px #fff solid;\n}\n.comp-ideaList .-idea .-col-info .-cont-info .-activity .-recent .-profile-left {\n  margin-left: -15px;\n}\n@media (max-width: 650px) {\n  .comp-ideaList .comp-ideaList__searchInfo,\n  .comp-ideaList comp-ideaList__searchTerm {\n    font-size: 15px;\n  }\n  .comp-ideaList .-idea {\n    align-items: flex-start;\n  }\n  .comp-ideaList .-idea .-col-vote {\n    min-width: 50px;\n  }\n  .comp-ideaList .-idea .-col-vote .-cont-vote .-score {\n    font-size: 18px;\n  }\n  .comp-ideaList .-idea .-col-vote .-cont-vote .-btn-vote {\n    font-size: 14px;\n    font-weight: 600;\n    width: 50px;\n  }\n  .comp-ideaList .-idea .-col-info .-cont-info .-title {\n    font-size: 15px;\n  }\n  .comp-ideaList .-idea .-col-info .-cont-info .-activity .-recent span:first-child > span,\n  .comp-ideaList .-idea .-col-info .-cont-info .-activity .-category {\n    display: none;\n  }\n  .comp-ideaList .-idea .-col-info .-cont-info .-activity .-recent .-profile-pic {\n    width: 18px;\n  }\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var NotificationList = exports.NotificationList = function (_React$Component) {
		...
		_createClass(NotificationList, [{
			key: '_toggleNotifications',
			value: function _toggleNotifications() {
				if (this.state.isVisible) {
					this.setState({ isVisible: false });
				} else {
					(0, _tracking.track)('notifications preview opened');
	    ...
	    */
					setTimeout(function () {
						(0, _API.clearNotifications)();
					}, 1000);
				}
			}
		}, {
			key: '_checkNotifications',
			value: function _checkNotifications() {
				var self = this;

				(0, _API.getNotifications)().done(function (results) {
					self.notifications = Object.keys(results).map(function (key) {
						return results[key];
					});
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: classes, 'aria-labelledby': 'dropdownMenu1' },
					_react2.default.createElement(
						'ul',
						{ className: '-inner-scrollable' },
						this.notifications.map(function (notification, key) {
							...
							return _react2.default.createElement(
								'li',
								{ key: key, className: notificationClasses },
								_react2.default.createElement(
									'a',
									{ href: url },
									_react2.default.createElement('img', { className: '-user-pic', src: notification.avatar, alt: 'Avatar' }),
									_react2.default.createElement('p', { className: '-description', dangerouslySetInnerHTML: (0, _helper.createMarkup)(notificationText) })
								)
							);
						}),
						_react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ href: seeAllUrl, className: '-btn-all-notifications' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Merge = exports.Merge = function (_React$Component) {
		_inherits(Merge, _React$Component);

		function Merge(props) {
			_classCallCheck(this, Merge);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Merge).call(this, props));
			...
			_this.selectedIdeaID = '';
			_this.selectedIdeaTitle = '';

			//function bindings
			_this._handleChange = _this._handleChange.bind(_this);
			_this._loadSearchResults = _this._loadSearchResults.bind(_this);
			_this._selectIdea = _this._selectIdea.bind(_this);
			_this._clearSelectedIdea = _this._clearSelectedIdea.bind(_this);
			_this._showConfirmModal = _this._showConfirmModal.bind(_this);
			return _this;
		}
		...
		_createClass(Merge, [{
			...
			value: function _handleChange(event) {
				...
				if (event.target.value.length > 0) {
					(0, _API.algolia_search)(event.target.value).then(function (results) {
			...
			key: '_clearSelectedIdea',
			value: function _clearSelectedIdea() {
				this.selectedIdeaID = '';
			...
			key: '_selectIdea',
			value: function _selectIdea(event) {
			...
			value: function _showConfirmModal() {
				$('#_modal-mergeIdea').modal('show');
			}
		}, {
			key: '_loadSearchResults',
			value: function _loadSearchResults(results) {
				var searchResults = [];
				...
				for (var i = 0; i < results.hits.length; i++) {
					...
					if (results.hits[i].objectID != window.mergeIdeaID) {
						...
						searchResults.push(_react2.default.createElement(
							'div',
							{ className: 'comp-merge__result-item', key: results.hits[i].objectID },
							_react2.default.createElement(
								'button',
								{ className: 'comp-merge__result-item__btn-select', onClick: this._selectIdea, 'data-id': results.hits[i].objectID, 'data-title': results.hits[i].title },
								'Select'
							),
							_react2.default.createElement(
								'div',
								{ className: 'comp-merge__result-item__info' },
								_react2.default.createElement(
									'h3',
									{ className: 'comp-merge__result-item__title' },
									results.hits[i].title,
									' ',
									_react2.default.createElement(
										'span',
										{ style: statusStyle, className: 'comp-merge__status' },
										results.hits[i].status
									)
								),
								_react2.default.createElement(
									'p',
									{ className: 'comp-merge__result-item__meta' },
									' ',
									results.hits[i].vote_count,
									' wants, ',
									results.hits[i].comment_count,
									' comments'
								)
							)
						));
			...
			value: function render() {
				...
				var mergeClasses = (0, _classnames2.default)({
					'comp-merge': true,
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'h2',
						{ className: 'comp-merge__main-title' },
						'Merge idea'
					),
					_react2.default.createElement(
						'p',
						{ className: 'comp-merge__info' },
						'You are about to merge this idea, so voting and commenting will be closed.'
					),
					_react2.default.createElement(
						'div',
						{ className: 'comp-merge__selected-item' },
						_react2.default.createElement(
							'h3',
							{ className: 'comp-merge__selected-item__title' },
							window.mergeIdeaTitle
						)
					),
					_react2.default.createElement(
						'h2',
						{ className: 'comp-merge__sub-title' },
						'Merge with:'
					),
					_react2.default.createElement(
						'p',
						{ className: 'comp-merge__info' },
						'Supporters and votes will be transferred to this idea. Comments will not be merged.'
					),
					_react2.default.createElement(
						'div',
						{ className: 'comp-merge__search-cont' },
						_react2.default.createElement('input', { className: 'comp-merge__search', onChange: this._handleChange, type: 'text', placeholder: 'Search ideas to merge with...' }),
						_react2.default.createElement(
							'div',
							{ className: 'comp-merge__search-results' },
							this.state.searchResults
						)
					),
					_react2.default.createElement(
						'div',
						{ className: 'comp-merge__selected-cont' },
						_react2.default.createElement(
							'div',
							{ className: 'comp-merge__selected-item' },
							_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ href: '#', className: 'comp-merge__btn-clear', onClick: this._clearSelectedIdea },
							_react2.default.createElement('img', { src: '/static/dashboard/img/icons/icon_cross_merge.png' })
						),
						_react2.default.createElement(
							'form',
							{ id: 'mergeIdeaForm', className: 'comp-merge__controls', method: 'POST', action: '.' },
							_react2.default.createElement('input', { type: 'hidden', name: 'merge_into_id', value: this.selectedIdeaID }),
							_react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: window.token } }),
							_react2.default.createElement(
								'a',
								{ href: '#', className: 'btn-fill-primary', onClick: this._showConfirmModal },
								'Merge'
							),
							_react2.default.createElement(
								'a',
								{ href: '#', className: 'btn-fill-transparent', onClick: this._clearSelectedIdea },
								'Cancel'
							)
						)
					)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/stylus-loader/index.js!./_merge.styl", function() {
				var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/stylus-loader/index.js!./_merge.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".comp-merge.is-default .comp-merge__selected-cont {\n  display: none;\n}\n.comp-merge.is-selected .comp-merge__search-cont {\n  display: none;\n}\n.comp-merge.is-selected .comp-merge__selected-cont {\n  display: block;\n}\n.comp-merge .comp-merge__main-title {\n  font-size: 30px;\n  font-weight: bold;\n  margin-bottom: 25px;\n}\n.comp-merge .comp-merge__info {\n  color: #a7a7a7;\n  font-size: 14px;\n  margin-bottom: 13px;\n}\n.comp-merge .comp-merge__selected-cont {\n  position: relative;\n  width: 100%;\n  max-width: 630px;\n}\n.comp-merge .comp-merge__status {\n  color: #fff;\n  border-radius: 10px;\n  padding: 0 12px;\n  font-size: 8px;\n  text-transform: uppercase;\n  line-height: 19px;\n  display: inline-block;\n}\n.comp-merge .comp-merge__selected-item {\n  background: #f2f2f2;\n  height: 70px;\n  max-width: 630px;\n  width: 100%;\n  text-overflow: ellipsis;\n  overflow: hidden;\n}\n.comp-merge .comp-merge__selected-item .comp-merge__selected-item__title {\n  font-size: 18px;\n  font-weight: bold;\n  line-height: 70px;\n  margin-left: 30px;\n  max-width: 570px;\n  margin: 0 0 0 25px;\n}\n.comp-merge .comp-merge__sub-title {\n  font-size: 16px;\n  font-weight: bold;\n  margin: 35px 0 25px;\n  text-transform: uppercase;\n}\n.comp-merge .comp-merge__search {\n  background-image: url(\"/static/dashboard/img/icons/magnify.png\");\n  background-position: 16px center;\n  background-repeat: no-repeat;\n  background-size: 25px;\n  border: 1px solid #dadada;\n  height: 45px;\n  font-size: 16px;\n  max-width: 630px;\n  width: 100%;\n  padding-left: 67px;\n  margin-bottom: 40px;\n}\n.comp-merge .comp-merge__search-results {\n  max-width: 630px;\n  width: 100%;\n}\n.comp-merge .comp-merge__btn-clear {\n  right: 0;\n  top: 25px;\n  right: -34px;\n  display: block;\n  width: 13px;\n  position: absolute;\n}\n.comp-merge .comp-merge__btn-clear img {\n  width: 100%;\n}\n.comp-merge .comp-merge__result-item {\n  position: relative;\n  margin-bottom: 50px;\n  width: 100%;\n}\n.comp-merge .comp-merge__result-item:last-child {\n  margin-bottom: 0;\n}\n.comp-merge .comp-merge__result-item .comp-merge__result-item__title {\n  font-size: 20px;\n  font-weight: 600;\n  line-height: 28px;\n  margin: 0 0 5px;\n}\n.comp-merge .comp-merge__result-item .comp-merge__result-item__meta {\n  color: #a3a3a3;\n  font-size: 13px;\n  margin: 0;\n}\n.comp-merge .comp-merge__result-item .comp-merge__result-item__btn-select {\n  background: #e94095;\n  border: none;\n  color: #fff;\n  height: 40px;\n  font-size: 16px;\n  font-weight: bold;\n  left: 0;\n  top: 50%;\n  margin-top: -20px;\n  position: absolute;\n  width: 77px;\n}\n.comp-merge .comp-merge__result-item .comp-merge__result-item__info {\n  padding-left: 112px;\n}\n.comp-merge .comp-merge__result-item::-webkit-input-placeholder,\n.comp-merge .comp-merge__result-item:-moz-placeholder,\n.comp-merge .comp-merge__result-item::-moz-placeholder,\n.comp-merge .comp-merge__result-item:-ms-input-placeholder {\n  color: #959595;\n}\n.comp-merge .comp-merge__controls {\n  margin-top: 65px;\n}\n.comp-merge .comp-merge__controls button,\n.comp-merge .comp-merge__controls a {\n  float: left;\n}\n", ""]);
